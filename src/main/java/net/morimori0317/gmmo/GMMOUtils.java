...
public class GMMOUtils {
    ...
    public static Button createForgeModButton(Screen screen, int width) {
        return Button.builder(Component.translatable("fml.menu.mods"), button -> Minecraft.getInstance().setScreen(new net.minecraftforge.client.gui.ModListScreen(screen)))
                .width(width)
                .build();
    }
}
